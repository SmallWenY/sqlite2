...
public class Can2AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_can2_add);
    ...
    private void onClick() {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int count = 0;
                cursor = db.rawQuery("select * from Can_Two where dish_name = ?", new String[] {dishname.getText().toString()});
                ...
                if (count == 0) {
                    ...
                    if (cursor.moveToFirst()) {
                        ...
                        db.execSQL("insert into Can_Two(upload_time, upload_usr_id, upload_usr_name, dish_calorie, dish_price, dish_name) values(?, ?, ?, ?, ?, ?)", new Object[] {time, id, nickname, dishcalorie.getText().toString(), dishprice.getText().toString(), dishname.getText().toString()});
                        Toast.makeText(Can2AddActivity.this, "菜品添加成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
                else {
                    Toast.makeText(Can2AddActivity.this, "菜品已经被添加过啦！", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
