...
public class Canteen3Fragment extends Fragment {
    View view;
    private Canteen3ItemAdapter adapter;
    private List<Canteen3Model> itemList = null;
    private List<Canteen3Model> data = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View DataLayout = inflater.inflate(R.layout.fragment_canteen3, container, false);
        ...
        add = (FloatingActionButton) DataLayout.findViewById(R.id.fab_can3);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity().getApplicationContext(), Can3AddActivity.class);
    ...
    private void initData() {
        itemList = new ArrayList<Canteen3Model>();

        dbHelper = new MyDatabaseHelper(getActivity(), "Info.db", null, 1);  //注意这里的context是getActivity()
        db = dbHelper.getWritableDatabase();
        cursor = db.query("Can_Three", null, null, null, null, null, null);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Canteen3Model item = new Canteen3Model();
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            data = (List<Canteen3Model>) msg.obj;
            adapter = new Canteen3ItemAdapter(getActivity(), R.layout.item_can1, data);
